...
gghfile = TFile(var+"/gen_ggh70.root", "READ")
genggh = gghfile.Get("gen"+var.lower()+"ggh")
genggh.SetXTitle(lbl)
genggh.SetYTitle("Gen Level Events")
genggh.SetMinimum(0.0)
if (var=="LeadEta" or var=="SubleadEta"): genggh.SetMaximum(4000.0)
if (var=="LeadPT" or var=="SubleadPT" or var=="DiphotonPT"): genggh.SetMaximum(8200.0)
if (var=="DR"): genggh.SetMaximum(4225.0)
genggh.SetLineColor(kRed+2)
genggh.Draw("histsame")

alpfile = TFile(var+"/gen_alp70.root", "READ")
genalp = alpfile.Get("gen"+var.lower()+"alp")
genalp.SetMinimum(0.0)
genalp.SetLineColor(kViolet-6)
genalp.Draw("histsame")

gghfileacc = TFile(var+"/gen_ggh70acc.root", "READ")
...
alpfileacc = TFile(var+"/gen_alp70acc.root", "READ")
...
leg.SetBorderSize(0)
#leg.SetTextSize(0.2)
leg.SetHeader("70 GeV BSM Models","C")
if (var=="DR"):
...
c1.Update()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_70gev.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_70gev.pdf")
...
c1.Update()
c1.SetLogy()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_70gev_log.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_70gev_log.pdf")
