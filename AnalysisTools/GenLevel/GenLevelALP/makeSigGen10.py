...
genmassggh = TH1F("genmassggh","genmassggh", 200,9.75,10.25); genmassggh.Sumw2()
genmassgghacc = TH1F("genmassgghacc","genmassgghacc", 200,9.75,10.25); genmassgghacc.Sumw2()
...
genmassalp = TH1F("genmassalp","genmassalp", 200,9.75,10.25); genmassalp.Sumw2()
genmassalpacc = TH1F("genmassalpacc","genmassalpacc", 200,9.75,10.25); genmassalpacc.Sumw2()
...
genleadetaggh.SaveAs("LeadEta/gen_ggh10.root")
gensubleadetaggh.SaveAs("SubleadEta/gen_ggh10.root")
genleadptggh.SaveAs("LeadPT/gen_ggh10.root")
gensubleadptggh.SaveAs("SubleadPT/gen_ggh10.root")
gendiphotonptggh.SaveAs("DiphotonPT/gen_ggh10.root")
gendrggh.SaveAs("DR/gen_ggh10.root")
genmassggh.SaveAs("Mass/gen_ggh10.root")

genleadetagghacc.SaveAs("LeadEta/gen_ggh10acc.root")
gensubleadetagghacc.SaveAs("SubleadEta/gen_ggh10acc.root")
genleadptgghacc.SaveAs("LeadPT/gen_ggh10acc.root")
gensubleadptgghacc.SaveAs("SubleadPT/gen_ggh10acc.root")
gendiphotonptgghacc.SaveAs("DiphotonPT/gen_ggh10acc.root")
gendrgghacc.SaveAs("DR/gen_ggh10acc.root")
genmassgghacc.SaveAs("Mass/gen_ggh10acc.root")

genleadetaalp.SaveAs("LeadEta/gen_alp10.root")
gensubleadetaalp.SaveAs("SubleadEta/gen_alp10.root")
genleadptalp.SaveAs("LeadPT/gen_alp10.root")
gensubleadptalp.SaveAs("SubleadPT/gen_alp10.root")
gendiphotonptalp.SaveAs("DiphotonPT/gen_alp10.root")
gendralp.SaveAs("DR/gen_alp10.root")
genmassalp.SaveAs("Mass/gen_alp10.root")

genleadetaalpacc.SaveAs("LeadEta/gen_alp10acc.root")
gensubleadetaalpacc.SaveAs("SubleadEta/gen_alp10acc.root")
genleadptalpacc.SaveAs("LeadPT/gen_alp10acc.root")
gensubleadptalpacc.SaveAs("SubleadPT/gen_alp10acc.root")
gendiphotonptalpacc.SaveAs("DiphotonPT/gen_alp10acc.root")
gendralpacc.SaveAs("DR/gen_alp10acc.root")
genmassalpacc.SaveAs("Mass/gen_alp10acc.root")
