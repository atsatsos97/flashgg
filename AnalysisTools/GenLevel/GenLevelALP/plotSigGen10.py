...
gghfile = TFile(var+"/gen_ggh10.root", "READ")
...
alpfileacc = TFile(var+"/gen_alp10acc.root", "READ")
...
leg.SetBorderSize(0)
#leg.SetTextSize(0.2)
leg.SetHeader("10 GeV BSM Models","C")
if (var=="DR"):
...
c1.Update()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_10gev_unweighted.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_10gev_unweighted.pdf")
...
c1.Update()
c1.SetLogy()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_10gev_unweighted_log.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_10gev_unweighted_log.pdf")
