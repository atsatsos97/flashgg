...
alpfileacc = TFile(var+"/gen_alp60acc.root", "READ")
...
if (var=="DR"):
  cat03 = TLine(0.3,0.0,0.3,1400.0)
...
leg.SetBorderSize(0)
#leg.SetTextSize(0.2)
leg.SetHeader("60 GeV BSM Models","C")
if (var=="DR"):
...
c1.Update()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_60gev.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_60gev.pdf")
...
genggh.SetMaximum(1000000)
gengghacc.SetMaximum(1000000)
genalp.SetMaximum(1000000)
genalpacc.SetMaximum(1000000)

c1.Update()
c1.SetLogy()
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_60gev_log.png")
c1.SaveAs("/eos/user/a/atsatsos/www/ALPMCDistributions_DEC2024/sig_gen_"+var.lower()+"_60gev_log.pdf")
