...
c1.SaveAs("/eos/user/a/atsatsos/www/DYMCDistributions_SEP2024/DY_"+lbl+"_EB.png")
c1.SaveAs("/eos/user/a/atsatsos/www/DYMCDistributions_SEP2024/DY_"+lbl+"_EB.pdf")
