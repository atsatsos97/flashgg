...
DY_t0.Draw(var+">>DY_all","weight*(CMS_hgg_mass>80 && CMS_hgg_mass<100 && abs(leadEta)<1.4442 && abs(subleadEta)<1.4442)","goff")
DY_t0.Draw(var+"_uncorr>>DY_alluncorr","weight*(CMS_hgg_mass>80 && CMS_hgg_mass<100 && abs(leadEta)<1.4442 && abs(subleadEta)<1.4442)","goff")
