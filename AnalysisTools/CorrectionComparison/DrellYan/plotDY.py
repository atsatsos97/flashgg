...
if ("PhotonIso" in lbl or "Sieie" in lbl or "Width" in lbl): leg = TLegend(0.53,0.70,0.88,0.85)
...
c1.SaveAs("/eos/user/a/atsatsos/www/DYMCDistributions_SEP2024/DY_"+lbl+".png")
c1.SaveAs("/eos/user/a/atsatsos/www/DYMCDistributions_SEP2024/DY_"+lbl+".pdf")
