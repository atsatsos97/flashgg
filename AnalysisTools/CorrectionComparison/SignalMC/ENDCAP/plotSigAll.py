...
c1.SaveAs("/eos/user/a/atsatsos/www/SigMCDistributions_JUN2024/Sig_"+lbl+"_EE.png")
c1.SaveAs("/eos/user/a/atsatsos/www/SigMCDistributions_JUN2024/Sig_"+lbl+"_EE.pdf")
