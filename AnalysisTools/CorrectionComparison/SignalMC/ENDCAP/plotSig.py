...
leg.SetBorderSize(0)
leg.SetHeader("Endcap |#eta|>1.556","C")
...
c1.SaveAs("/eos/user/a/atsatsos/www/SigMCDistributions_JUN2024/Sig_"+lbl+"_"+mass+"GeV_EE.png")
c1.SaveAs("/eos/user/a/atsatsos/www/SigMCDistributions_JUN2024/Sig_"+lbl+"_"+mass+"GeV_EE.pdf")
