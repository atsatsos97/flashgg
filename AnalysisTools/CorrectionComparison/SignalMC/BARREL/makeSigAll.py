...
for i in masses:
  ...
  ggh_t0.Draw(var+">>ggh_all","weight*(CMS_hgg_mass>0 && CMS_hgg_mass<80 && abs(leadEta)<1.4442 && abs(subleadEta)<1.4442)","goff")
  ggh_t0.Draw(var+"_uncorr>>ggh_alluncorr","weight*(CMS_hgg_mass>0 && CMS_hgg_mass<80 && abs(leadEta)<1.4442 && abs(subleadEta)<1.4442)","goff")
